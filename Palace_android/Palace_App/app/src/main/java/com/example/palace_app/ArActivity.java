package com.example.palace_app;
...
public class ArActivity extends BaseActivity
        implements RouteListener, ProgressChangeListener, OffRouteListener {
    ...
    private Point origin = Point.fromLngLat(27.654285, 53.928057);
    private Point ROUTE_DESTINATION = Point.fromLngLat(126.977230, 37.583005);
        ...
        if (allPermissionsGranted() && !navigationWasStarted) {
            ...
            locationCallback = new LocationEngineCallback<LocationEngineResult>() {
                ...
                public void onSuccess(LocationEngineResult result) {
                    ...
                    origin = Point.fromLngLat(result.getLastLocation().getLongitude(),
                            result.getLastLocation().getLatitude());
                    Toast.makeText(ArActivity.this, String.format(getString(R.string.new_location),
    ...
    private void initDirectionsRoute(Point origin) {
